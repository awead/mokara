...
RSpec.describe Mokara::Public do
  describe '::get' do
    ...
    context 'when the orcid does not exist' do
      ...
      it 'raises Mokara::NotFound' do
        expect { call }.to raise_error(Mokara::NotFound, 'Nothing to see here...')
      end
    end
    ...
    context 'with an unknown error' do
      ...
      it 'raises Mokara::Error' do
        expect { call }.to raise_error(Mokara::Error, 'Something went wrong.')
      end
    end
  end
end
